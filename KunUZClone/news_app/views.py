...
def HomePageView(request):
    ...
    local_1 = News.published.all().filter(category__name="Uzbekiston").order_by("-publish_time")[0]
    ...
    sport_1 = News.published.all().filter(category__name="Sport").order_by("-publish_time")[0]
    sport_2 = News.published.all().filter(category__name="Sport").order_by("-publish_time")[1]
    ...
    fan_texnika_1 = News.published.all().filter(category__name="Fan-texnika").order_by("-publish_time")[0]
